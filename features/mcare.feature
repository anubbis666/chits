Feature: maternal care
   ...
   Scenario: Patient Search
		...
		And I should see "MATERNAL REGISTRY RECORDS"
...
Scenario: postpartum
		Given I am logged in as "user" with password "user"
		When I am on the maternal prenatal
		And I click "POSTPARTUM"
		And I fill in "delivery_date" with "12/17/2009"
		And I fill in "obscore_gp" with "1001"
		And I fill in "obscore_fpal" with "1000"
		...
		Then I should see "DELIVERY DATE: 2009-12-17"
